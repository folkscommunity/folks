...
export function EasterEgg({ mobile }: { mobile?: boolean }) {
  const [disabled, setDisabled] = useState(false);

  const { reward, isAnimating } = useReward(
    mobile ? "easteranimation-mobile" : "easteranim",
    "emoji",
    {
      emoji: ["🐰", "🥚", "🐣", "🌷", "🐇", "🐥"],
      startVelocity: 20,
  ...
  return (
    <>
      <div
        ...
        id={mobile ? "easteranimation-mobile2" : "easteranim"}
        title="Happy Easter!"
      >
        {mobile && (
          <div
            className="pointer-events-none absolute left-[40%] top-5 z-[9999999]"
            id="easteranimation-mobile"
          ></div>
        )}

        <EggSVG size={mobile ? 32 : 22} />
      </div>
    </>
  );
}
...
function EggSVG({ size }: { size: number }) {
  return (
    <svg
      ...
      width={size}
      version="1.1"
      className="transition-all hover:scale-[1.5]"
      id="Layer_1"
      viewBox="0 0 512 512"
      xmlSpace="preserve"
    >
      <path
        ...
        d="M405.374,87.872C365.953,31.207,312.905,0,255.999,0S146.046,31.207,106.625,87.872  C68.58,142.563,47.627,214.958,47.627,291.721C47.627,413.183,141.102,512,255.999,512s208.372-98.817,208.372-220.279  C464.372,214.958,443.419,142.563,405.374,87.872z"
      />
      <path
        style={{
          fill: "#EE5DA2"
        }}
        d="M255.999,512c114.898,0,208.372-98.817,208.372-220.279c0-76.763-20.953-149.157-58.998-203.849  C365.953,31.207,312.905,0,255.999,0"
      />
      <g>
        <path
          style={{
          ...
          d="M446.452,381.023c10.637-25.256,16.916-52.998,17.8-82.158H47.749   c0.883,29.16,7.162,56.902,17.8,82.158H446.452z"
        />
        <path
          style={{
            fill: "#FFC170"
          }}
          d="M456.32,210.753c-6.814-33.388-17.852-64.792-32.722-92.874H88.399   c-14.869,28.083-25.907,59.486-32.72,92.874H456.32z"
        />
      </g>
      <g>
        <path
          ...
          d="M456.32,210.753c-6.814-33.388-17.852-64.792-32.722-92.874H255.999v92.874H456.32z"
        />
        <path
          style={{
            fill: "#FF9811"
          }}
          d="M446.452,381.023c10.637-25.256,16.916-52.998,17.8-82.158H255.999v82.158H446.452z"
        />
      </g>
      <g>
        <path
