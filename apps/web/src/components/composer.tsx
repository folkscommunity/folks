    ...
    <div className="px-4 py-4">
      <Drawer.Root open={open} onOpenChange={setOpen}>
        <Drawer.Trigger asChild>
          <button className="bg-black-900 dark:bg-black-800 text-black-100 fixed bottom-12 right-4 z-[997] rounded-full border border-neutral-300/0 p-2 dark:border-slate-800 dark:text-slate-400">
